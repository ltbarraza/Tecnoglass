...
<body>
	...
	<div class="container">
		...
		<div class="row">
					...
					<tbody>
						<c:forEach items="${clientes}" var="cliente">
							<tr>
								...
								<td><c:out value="${cliente.nacionalidad}"></c:out></td>
								<td><c:out value="${cliente.correo}"></c:out></td>
								<td><a href='<c:url value="/cliente/CRUD/${cliente.idCliente}"></c:url>' class="btn btn-success">Editar</a></td>
								<td><a href='<c:url value="/cliente/delete/${cliente.idCliente}"></c:url>' class="btn btn-danger">Eliminar</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
			...
			<a href='<c:url value="/cliente/CRUD/0"></c:url>' class="btn btn-primary">Nuevo
				Usuario</a>
		</div>
	</div>
