...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-6">
				<sf:form
					action="${pageContext.request.contextPath}/orden/SaveOrden"
					method="post" commandName="orden">


					<input type="hidden" name="estado.idEstado" value="${estado.idEstado}">
						...
						<div class="panel-body">
							<div class="form-group">
								...
								<c:forEach items="${clientes}" var="cliente">
									...
									<c:set var="asignadas" value="false"></c:set>

									<ul class="list-group">
										<li class="list-group-item"><label> <input
												id="litemp" type="radio" name="cliente.idCliente"
												value="${cliente.idCliente}" /> <c:out
													value="${cliente.nombre}"></c:out></label></li>
									</ul>
								</c:forEach>
							</div>
						</div>
