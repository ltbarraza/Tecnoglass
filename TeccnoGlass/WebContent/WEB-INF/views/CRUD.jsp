...
<body>
	...
	<div class="container">
			...
			<div class="navbar navbar-light navbar-fixed-top"
				...
				<div class="row">
					...
					<ul class="nav navbar-nav">
						...
						<li><a href='<c:url value="/consultores"/>'>Ordenes</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<sf:form
			action="${pageContext.request.contextPath}/cliente/SaveUpdate"
			method="post" commandName="cliente" id="formdata">

			<c:if test="${cliente.idCliente ne 0}">
				<sf:input path="idCliente" type="hidden" />
			</c:if>
